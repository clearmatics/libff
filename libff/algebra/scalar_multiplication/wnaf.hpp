...
/**
 * Find the wNAF representation of the given scalar relative to the given window
 * size.
 */
template<mp_size_t n>
...
/**
 * In additive notation, use wNAF exponentiation (with the given window size) to
 * compute scalar * base.
 */
