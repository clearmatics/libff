...
bls12_381_Fq12 bls12_381_pp::pairing(
    const bls12_381_G1 &P, const bls12_381_G2 &Q)
{
    return bls12_381_pairing(P, Q);
}

bls12_381_Fq12 bls12_381_pp::reduced_pairing(
    const bls12_381_G1 &P, const bls12_381_G2 &Q)
{
