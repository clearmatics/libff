...
bool bls12_381_ate_ell_coeffs::operator==(
    const bls12_381_ate_ell_coeffs &other) const
{
    return (
...
bool bls12_381_ate_G2_precomp::operator==(
    const bls12_381_ate_G2_precomp &other) const
{
    return (
