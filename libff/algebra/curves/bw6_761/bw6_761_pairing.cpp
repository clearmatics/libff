...
bw6_761_GT bw6_761_final_exponentiation(const bw6_761_Fq6 &elt)
{
    ...
    bw6_761_Fq6 elt_to_first_chunk = bw6_761_final_exponentiation_first_chunk(elt);
...
void doubling_step_for_miller_loop(bw6_761_G2 &current,
                                   bw6_761_ate_ell_coeffs &c)
{
                                    ...
                                    const bw6_761_ate_G2_precomp &prec_Q)
{
    ...
    // loop_count_1 = u+1
    // This allows to cover steps 2 to 11 Algorithm 5: https://eprint.iacr.org/2020/351.pdf
    ...
    const bw6_761_ate_G2_precomp &prec_Q2)
{
    ...
    for (long i = NAF_1.size() - 1; i >= 0; --i)
    {
        ...
        f_1 = f_1.squared();
        f_1 = f_1.mul_by_045(c_1_1.ell_0, prec_P1.PY * c_1_1.ell_VW, prec_P1.PX * c_1_1.ell_VV);
        f_1 = f_1.mul_by_045(c_1_2.ell_0, prec_P2.PY * c_1_2.ell_VW, prec_P2.PX * c_1_2.ell_VV);
