...
public:
    ...
    bls12_377_G1();
    bls12_377_G1(const bls12_377_Fq& X, const bls12_377_Fq& Y, const bls12_377_Fq& Z) : X(X), Y(Y), Z(Z) {};
    ...
    static void read_uncompressed_unsafe(std::istream &, bls12_377_G1 &);
    static void read_compressed_unsafe(std::istream &, bls12_377_G1 &);
