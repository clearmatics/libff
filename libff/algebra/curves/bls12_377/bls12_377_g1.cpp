...
void bls12_377_G1::print() const
{
    ...
    else
    {
        ...
        gmp_printf("(%Nd , %Nd)\n",
                   copy.X.as_bigint().data, bls12_377_Fq::num_limbs,
                   copy.Y.as_bigint().data, bls12_377_Fq::num_limbs);
    }
}
...
void bls12_377_G1::print_coordinates() const
{
    ...
    {
        gmp_printf("(%Nd : %Nd : %Nd)\n",
                   this->X.as_bigint().data, bls12_377_Fq::num_limbs,
                   this->Y.as_bigint().data, bls12_377_Fq::num_limbs,
                   this->Z.as_bigint().data, bls12_377_Fq::num_limbs);
    }
}
...
bool bls12_377_G1::is_zero() const
{
...
#else
    // c0: 1
    // c1: 91893752504881257701523279626832445441 (0x452217cc900000010a11800000000001)
...
void bls12_377_G1::batch_to_special_all_non_zeros(std::vector<bls12_377_G1> &vec)
{
