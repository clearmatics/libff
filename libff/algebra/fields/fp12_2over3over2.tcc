...
{
    return Fp6_3over2_model<n, modulus>(non_residue * elt.coeffs[2], elt.coeffs[0], elt.coeffs[1]);
}
...
{
    return Fp12_2over3over2_model<n,modulus>(this->coeffs[0] + other.coeffs[0],
...
{
    return Fp12_2over3over2_model<n,modulus>(lhs*rhs.coeffs[0],
                                             lhs*rhs.coeffs[1]);
}
...
{
    return Fp12_2over3over2_model<n,modulus>(-this->coeffs[0],
                                             -this->coeffs[1]);
}
...
{
    return Fp12_2over3over2_model<n,modulus>(coeffs[0].Frobenius_map(power),
