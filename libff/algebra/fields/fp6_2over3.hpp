...
public:
    ...
    my_Fp3 coeffs[2];
    Fp6_2over3_model() {};
    Fp6_2over3_model(const my_Fp3& c0, const my_Fp3& c1) { this->coeffs[0] = c0; this->coeffs[1] = c1; return; };
    Fp6_2over3_model(const my_Fp3 in_coeffs[2]) { this->coeffs[0] = in_coeffs[0]; this->coeffs[1] = in_coeffs[1]; return; };
