...
public:
    static const typename FieldT::my_Fp &get_component_0(const FieldT &field_el)
    {
        ...
        return component_0_getter<NextSubfield>::get_component_0(field_el.coeffs[0]);
    }
};
...
{
public:
    static const Fp_model<n, modulus> &get_component_0(const Fp_model<n, modulus> &field_el)
    {
        return field_el;
    }
};
